...
return t&&e.push(t),e.join(" ")}),actions:{handleFocus:function(e){Ember.isEmpty(e.options)||(Ember.run.scheduleOnce("actions",e,e.actions.search),Ember.run.scheduleOnce("actions",e,e.actions.open))},onKeyDown:function(e,t){var n=Ember.get(this,"onkeydown")
...
function r(e){return e?e.toArray?e.toArray():e:[]}Object.defineProperty(e,"__esModule",{value:!0}),e.default=t.default.extend({mustShowSearchMessage:!1,canLoadMore:!0,actions:{search:function(e){Ember.set(this,"canLoadMore",!0),Ember.isBlank(e)?this.updateState({results:r(Ember.get(this,"options")),_rawSearchResults:Ember.get(this,"options"),resultsCount:(0,n.countOptions)(Ember.get(this,"options")),lastSearchedText:"",loading:!1}):this.get("search")?this._performSearch(e):this._performFilter(e)},onScroll:function(){var e=this
